...
# Add the healthcare keyword flag to the feature matrix
X_additional_features = np.array(dat['Healthcare_Keyword_Flag']).reshape(-1, 1)
...
plt.xlabel('Epochs')
plt.ylabel('F1 Score')
plt.title('MLP-SCA-SVM Model using Gmail Dataset & Content-based Filtering')
plt.grid(True)
plt.legend()
plt.show()
